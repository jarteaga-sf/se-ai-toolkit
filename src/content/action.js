...
export const quickReference = {
  ...
  toolMatrix: [
    { scenario: 'Personalize a demo for a specific customer in under 30 minutes', tool: 'Saleo' },
    { scenario: 'Show the prospect\'s own data and branding in the demo', tool: 'Saleo' },
    { scenario: 'Switch between VP, manager, and rep views mid-call', tool: 'Saleo' },
    ...
    { scenario: 'Prep for a call — customer brief, discovery questions, synthesis', tool: 'Cursor' },
    { scenario: 'Understand code you inherited from another SE', tool: 'Cursor (Ask mode)' },
    { scenario: 'Tweak a demo component before a customer call', tool: 'Cursor (Cmd+K)' },
    { scenario: 'Build and deploy something end-to-end from a single prompt', tool: 'Claude Code' },
  ],
  commands: [
