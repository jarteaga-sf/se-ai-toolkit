...
/**
 * Vibe Coding: Before/After — Manual code vs describe in English
 */
export function VibeCodingIllustration() {
  return (
    <div className="flex flex-col items-center gap-6 w-[340px]">
      {/* Before: Manual */}
      <div className="w-full rounded-xl border border-[var(--color-border)]/60 bg-[var(--color-bg-white)] overflow-hidden opacity-50">
        <div className="bg-[#1E1E1E] px-3 py-1.5 flex items-center gap-1.5">
          ...
          <span className="text-[8px] font-mono text-[#666] ml-1">manual.cls</span>
        </div>
        <div className="px-3 py-2 bg-[#1E1E1E]">
          <p className="text-[9px] font-mono text-[#C586C0]">public class LeadScorer {'{'}</p>
          <p className="text-[9px] font-mono text-[#9CA3AF] pl-3">// 200 lines of logic...</p>
          <p className="text-[9px] font-mono text-[#9CA3AF] pl-3">// 3 hours of work...</p>
          <p className="text-[9px] font-mono text-[#C586C0]">{'}'}</p>
        </div>
      </div>
      ...
      <div className="w-full rounded-xl border-2 border-[var(--color-accent)]/30 bg-[var(--color-surface)] p-4">
        <div className="flex items-start gap-2.5">
          ...
          <div>
            <p className="text-[13px] text-[var(--color-heading)] font-bold leading-snug">
  ...
  return (
    <div className="flex flex-col items-center gap-3 w-[320px]">
      ...
      <div className="flex items-center gap-3 w-full">
        ...
        {/* Agent */}
        <div className="flex flex-col items-center gap-1 flex-shrink-0">
          <div className="w-10 h-10 rounded-full bg-[var(--color-accent)]/10 border-2 border-[var(--color-accent)]/30 flex items-center justify-center">
